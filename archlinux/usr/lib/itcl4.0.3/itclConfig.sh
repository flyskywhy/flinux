...
# build directory.
itcl_BUILD_LIB_SPEC='-L/usr/lib/itcl4.0.3 -litcl4.0.3'
ITCL_BUILD_LIB_SPEC='-L/usr/lib/itcl4.0.3 -litcl4.0.3'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L/usr/lib/itcl4.0.3 -litclstub4.0.3'
ITCL_BUILD_STUB_LIB_SPEC='-L/usr/lib/itcl4.0.3 -litclstub4.0.3'
...
# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='/usr/lib/itcl4.0.3/libitclstub4.0.3.a'
ITCL_BUILD_STUB_LIB_PATH='/usr/lib/itcl4.0.3/libitclstub4.0.3.a'
